/*
 * Polyline source management
 */
SimpleGIS.Data.DataSourcePolyline = class DataSource extends SimpleGIS.Data.DataSource
{
  /*
  ...
  {
    super(name, reference, 'polyline', dataFile, description, style, customStyles, group, popupParams, autoload);
  }

  /*
   * Set style of layer of type polyLine
   */
  setLayerStyle()
  {
    let me = this;
